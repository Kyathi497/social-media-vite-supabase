      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="font-mono text-xl font-bold text-white">
            Social<span className="text-purple-500">.meida</span>
          </Link>
          {/* //Desktop links// */}
          ...
          <div className="hidden md:flex items-center ">
            {user ? (
              <div className="flex items-center space-x-4">
                ...
                <button className="bg-red-500 px-3 py-1" onClick={signOut}>Sign Out</button>
              </div>
            ) : (<button className="bg-blue-500 px-3 py-1 rounded" onClick={signInWithGitHub}>Sign In with Github</button>)}

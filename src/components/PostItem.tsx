    ...
    return (
        <div className="relative group">
            ...
            <Link to={`/post/${post.id}`} className="block relative z-10">
                <div className="w-80 h-auto bg-[rgb(24,27,32)] border border-[rgb(84,90,106)] rounded-[20px] text-white flex flex-col p-5 overflow-hidden transition-colors duration-300 group-hover:bg-gray-800">

                    {/* Header: Avatar, Title, and Image */}
                    <div className="flex items-center space-x-2 mb-4">
                        ...
                        <div className="flex flex-col flex-1">
                            <div className="text-[20px] leading-[22px] font-semibold">{post.title}</div>
                        </div>
                    </div>
                    {/* Image Banner */}
